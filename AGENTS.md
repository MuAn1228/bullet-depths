...
| 代码量 | `js/` 下 22 个文件，约 11600 行 |
| 自测 | `index.html?boottest`，60 步，结果写进 `document.title` 与页面底部 `#errlog` |
| 当前自测状态 | **60 PASS / 0 FAIL**（2026-09-04 实测，含 BUG-001 修复、主角重做回归、拍立得/武器商店/赌徒的灾难/解锁与词缀/第三层与无面君主/第三层新怪/基地系统/武器批次（纸飞机/吹风机/切割刀/太阳左轮重做/点唱机）/Wallmaker 掩体制造者/音频系统 2.0 回归步骤） |
