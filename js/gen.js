  ...
  for(const room of rooms){
    ...
    if(room.type==='combat'){
      ...
      const pool = floorNum===1
        ...
        : (floorNum===2
          ? [['gunner',1,2],['shotgunner',2,2],['sniper',2,2],['hexer',2,1.5],['beetle',1,2],['shield',2,1.5],['charger',1,1.5],['slime',1,1.5],['wisp',1,2],['totem',2,1.6],['bomber',2,2],['orbiter',2,1.4],['minelayer',1,1.6],['gravitator',2,1.5],['commander',2,1.2],['mirror',2,1.4],['mimic',2,1.3],['miner',2,1.5],['vaultling',2,1.5],['barrier_brute',2,1.4],['jester',2,1.3]]
          : [['shotgunner',2,2],['sniper',2,2.4],['hexer',2,2.2],['shield',2,1.8],['bomber',2,2.4],['wisp',1,2],['totem',2,1.8],['beetle',1,1.4],['voidstalker',2,2.2],['riftwatcher',2,2],['voidacolyte',2,1.8],['commander',2,1.3],['phaseprowler',2,1.6],['mimic',2,1.4],['miner',2,1.5],['vaultling',2,1.5],['barrier_brute',2,1.5],['footballer',2,1.4],['jester',2,1.3],['podcaster',2,1.2],['magnetron',2,1.3],['balloon_wisp',2,1.3]]);
      const comp=[];
      let g2=0;
