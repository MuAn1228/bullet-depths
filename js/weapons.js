...
W.defs = {
  ...
  jukebox:{ name:'过载点唱机', tier:'A', dmg:4, rate:1.8, mag:8, reload:1.6, spread:.02, pellets:1, speed:16, range:0, size:.18, pierce:99, bounce:99, knock:2, color:0x2a2438, sfx:'vinylShot', price:59, kind:'vinyl', jukebox:true, blurb:'黑胶弹射反弹 · 互撞搭建音波网' },
  dice:{ name:'悖论骰子', tier:'A', dmg:6, rate:3.6, mag:10, reload:1.5, spread:0, pellets:1, speed:10, range:20, size:.17, pierce:0, bounce:0, knock:2, color:0xd8cfe0, sfx:'diceStop', price:55, dice:true, blurb:'掷骰改判现实 · 连续同数扭曲时空' },
};
