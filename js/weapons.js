...
W.defs = {
  ...
  dice:{ name:'悖论骰子', tier:'A', dmg:8, rate:3.6, mag:10, reload:1.5, spread:0, pellets:1, speed:20, range:35, size:.17, pierce:0, bounce:0, knock:2, color:0xd8cfe0, sfx:'diceStop', price:55, dice:true, blurb:'掷骰改判现实 · 连续同数扭曲时空' },
};
